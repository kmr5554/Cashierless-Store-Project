...
def textmerge(txt_path,mv_path):
  os.chdir(mv_path)
  ...
  cam_list=os.listdir(txt_path)
  print(cam_list)
  folder_list=[]
  for i in range(len(cam_list)):
    if os.path.isdir(os.path.join(txt_path,cam_list[i])):
      folder_list.append(cam_list[i])
  for i in range(len(folder_list)):
    path = os.path.join(txt_path, folder_list[i])  
